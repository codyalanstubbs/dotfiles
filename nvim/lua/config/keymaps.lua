...
-- keymap.set("n", "<C-n>", function() harpoon:list():select(0) end)
-- keymap.set("n", "<C-m>", function() harpoon:list():select(1) end)
-- keymap.set("n", "<C-s>", function() harpoon:list():select(2) end)
--
